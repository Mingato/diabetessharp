...
export function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Hard-coded test user for internal testing (simulates a paying user)
    if (email === "test@neurosharp.com" && password === "Test123!") {
      localStorage.setItem("neurosharp_token", "test-user");
      ...
      <div className="w-full max-w-[400px] animate-in-up">
        <div className="mb-8 text-center">
          <Link to="/home" className="inline-flex items-center gap-3 justify-center mb-4">
            <img src="/neurosharp-logo.png" alt="NeuroSharp" className="h-12 w-12 object-contain" />
            <span className="font-display font-bold text-xl text-[var(--color-text)]">NeuroSharp</span>
          </Link>
        ...
        <p className="text-center text-sm text-[var(--color-text-muted)] mt-3">
          Test login: <span className="font-mono">test@neurosharp.com</span> / <span className="font-mono">Test123!</span>
        </p>
