...
# A4 landscape é 841.89 x 595.27 points
# Vamos usar um tamanho personalizado que case com 1920x1080 para evitar cortes
PDF_WIDTH = 842
...
def create_pdf():
    ...
    for img_file in image_files:
        ...
        # Converter WebP para PNG temporário (ReportLab não suporta WebP nativamente em algumas versões)
        try:
