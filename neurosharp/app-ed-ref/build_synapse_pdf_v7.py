...
# List of generated slide images in order (including ALL new slides)
slides = [
    ...
    "/home/ubuntu/synapse_pitch_deck/s22_daily_journey_generated.webp",
    "/home/ubuntu/synapse_pitch_deck/s23_family_reminders_generated.webp",
    "/home/ubuntu/synapse_pitch_deck/s24_scene_supermarket_generated.webp", # New Scene 1
    "/home/ubuntu/synapse_pitch_deck/s25_scene_medicine_generated.webp",    # New Scene 2
    "/home/ubuntu/synapse_pitch_deck/s26_scene_person_generated.webp",      # New Scene 3
    "/home/ubuntu/synapse_pitch_deck/s27_scene_wallet_generated.webp",      # New Scene 4
...
def make_pdf(pdf_path, image_files):
    ...
    if not os.path.exists(image_files[0]):
        print(f"Error: First image not found: {image_files[0]}")
        return
    ...
    dpi = 150
    page_w_pt = (img_w / dpi) * 72
    page_h_pt = (img_h / dpi) * 72
...
make_pdf("/home/ubuntu/Synapse_PitchDeck_FINAL_v4.pdf", slides)
