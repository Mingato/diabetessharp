...
export const CHECKLIST_BY_MEAL: { meal: MealType; label: string; items: { id: string; name: string; benefit: string }[] }[] = [
  {
    ...
    label: "Breakfast",
    items: [
      { id: "b1", name: "Oatmeal or whole grains", benefit: "Fiber, low glycemic" },
      { id: "b2", name: "Berries (blueberries, strawberries)", benefit: "Antioxidants, flavonoids" },
      { id: "b3", name: "Eggs", benefit: "Protein, blood sugar friendly" },
  ...
  },
  {
    ...
    label: "Dinner",
    items: [
      { id: "d1", name: "Salmon, trout, or mackerel", benefit: "Omega-3, lean protein" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "s5", name: "Green tea", benefit: "Zero sugar, antioxidants" },
